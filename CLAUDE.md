...
**Agent Memory :** get_agent_profile, update_agent_memory
**Web :** fetch_article
...
| settings | key (PK), value (JSONB) | keys: linkedin, veille_sources, agent_profile, content_strategy, agent_memories |
